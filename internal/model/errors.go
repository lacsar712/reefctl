...
var (
	...
	ErrRefrigerantHigh   = errors.New("reefctl: refrigerant pressure high")
	ErrDefrostPending    = errors.New("reefctl: defrost pending")
	ErrZoneHold          = errors.New("reefctl: zone hold not satisfied")
)
